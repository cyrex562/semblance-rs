use crate::x86_instr_arg_type::X86ArgType::{
    AH, AL, ALS, AX, AXS, BH, BL, BP, BX, CH, CL, CX, DH, DI, DL, DSBX, DSSI, DX, DXS, ESDI, IMM,
    IMM16, IMM8, MEM, MOFFS, NONE, REG, REL, REL8, RM, SEG16, SI, SP,
};
use crate::x86_instr_def::{
    OP_ARG2_IMM, OP_ARG2_IMM8, OP_BRANCH, OP_FAR, OP_IMM64, OP_LOCK, OP_OP32_REGONLY, OP_REP,
    OP_REPE, OP_REPNE, OP_STACK, OP_STOP, OP_STRING,
};
