use crate::x86_instr_arg_type::X86ArgType::{AX, BP, BX, CR32, CX, DI, DR32, DX, FS, GS, IMM8, MEM, NONE, REG, REL, RM, SI, SP, TR32};
use crate::x86_instr_def::{OP_ARG2_CL, OP_ARG2_IMM8, OP_BRANCH, OP_LOCK, OP_OP32_REGONLY, OP_STACK};
